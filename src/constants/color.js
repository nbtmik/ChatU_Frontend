...
// export const bgGradient = "linear-gradient(rgba(203,18,18,0.5),rgba(120,110,220,0.5))";
// export const purple = "rgba(75,12,192,1)";
// export const purpleLight = "rgba(75,12,192,0.2)";

export const orange = "linear-gradient(rgba(203,18,18,0.5),rgba(120,110,220,0.5))";
export const orangeLight = "rgba(234, 112, 112,0.2)";
